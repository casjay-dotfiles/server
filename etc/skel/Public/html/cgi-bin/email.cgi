...
sub return_html {
 ...
 print "<td colspan=3 align=center bgcolor=#D0D0D0><font face=arial>Please direct all inquiries to <a href=\"mailto:$Config{'recipient'}\">$Config{'recipient'}</a></td></tr>\n";
        ...
        if ($Config{'return_link_url'} && $Config{'return_link_title'}) {
            ...
            print "<td colspan=3 align=center bgcolor=#C0C0C0><font face=arial size=-2><a href=\"http://casjaysdev.pro/\">CasjaysDev</a></td></tr>\n";
      ...
      <tr><td>
          <table   border=0 cellpadding=2 cellspacing=0 width=650>
              ...
              Bad Referrer - Access Denied</b></td></tr>
                ...
                <font face=arial size=-2><a href="javascript: history.go(-1)">Go Back</a><br><a href="http://casjaysdev.pro">CasjaysDev.pro</a>
                </td>
                </tr>
          </table>
       </td></tr>
          ...
          <table   border=0 cellpadding=2 cellspacing=0 width=650>
              ...
              GFFormMail</b></td></tr>
                ...
                <td width=150>
                    ...
                    A free product from Network Now! <BR>Adapted from Matt Wright's<br> FormMail v 1.6 - Released May 02, 1997<br>
        <a href="http://www.worldwidemart.com/scripts/">Matt's Script Archive,
        Inc.</a>
                </td>
                <td width=150>
                </td></tr><tr><td colspan=3><br></td></tr>
      ...
      <tr><td>
          <table   border=0 cellpadding=2 cellspacing=0 width=650>
              ...
              Error: No Recipient</b></td></tr>
                <tr>
                <td width=150>
               </td><td bgcolor=#FFFFFF><font face=arial> <BR> No Recipient was specified in the data sent to CasjaysDev.pro FormMail.  Please
